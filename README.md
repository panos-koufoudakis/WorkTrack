...
Τα παρακάτω είναι έτοιμα placeholders. Μετά την τοπική εκτέλεση, αντικαταστήστε τα με πραγματικά screenshots για την τελική παρουσίαση.

| Σύνδεση | Dashboard |
| --- | --- |
| ![Login placeholder](docs/screenshots/login-placeholder.svg) | ![Dashboard placeholder](docs/screenshots/dashboard-placeholder.svg) |
